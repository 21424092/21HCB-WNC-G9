...
export default class MenuAdd extends PureComponent {
  constructor(props) {
    ...
    this.state = {
      ...
      ready: false,
      /** @var {Array} */
      parents: [{ name: "-- Chọn --", id: "" }],
      /** @var {Array} */
      functions: [{ name: "-- Chọn --", id: "" }],
    };
  }
  ...
  componentDidMount() {
    ...
    (async () => {
      ...
      let { parents = [], functions = [] } = this.state;
      //
  ...
  formikValidationSchema = Yup.object().shape({
    menu_name: Yup.string().required("Tên menu là bắt buộc."),
  ...
  handleFormikSubmit(values, fromProps) {
    ...
    let formData = Object.assign({}, values, {
      ...
      is_customer: 1 * values.is_customer,
    });
  ...
  render() {
    let { ready, alerts, initialValues, parents, functions } = this.state;
                              ...
                              <FormGroup row>
                                ...
                                <Col sm={9}>
                                  <Row>
                                    ...
                                    <Col xs={12} sm={4}>
                                      <div className="text-left py-2">
                                        <a
                                          ...
                                          href="https://coreui.io/react/demo/#/icons/font-awesome"
                                        >
                                    ...
                                    <Col xs={12}>
                                      <b>Lưu ý:</b> nếu dùng class icons "Font
                                      Awesome" thì thêm prefix <b>"fa fa-"</b>{" "}
                                      (vd: <b>"fa fa-address-book"</b>).
                                    </Col>
                                  </Row>
                                </Col>
                              </FormGroup>
                                  ...
                                  <Field
                                    ...
                                    render={({ field /* _form */ }) => (
                                      <CustomInput
                                        ...
                                        className="pull-left"
                                        onBlur={null}
                                        checked={values.is_customer}
                                        type="switch"
                                        id="is_customer"
                                        label="Menu phân hệ khách hàng?"
                                        disabled={noEdit}
                                      />
                                    )}
                                  />
